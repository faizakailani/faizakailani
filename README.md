...
**Full-Stack Software Engineer** — Lead Developer @ **PT LSKK** | Researcher @ **PUSTEKHAN ITB** 🌏 Bandung, Indonesia

I build backend-heavy full-stack systems with **NestJS**, **TypeScript**, **React**, and **PostgreSQL/MongoDB** — from government-scale platforms to AI-powered research tools. Also a final-semester Informatics Engineering student (GPA 3.92) wrapping up a thesis on **Q-Learning for smart lighting control**.

---

🚀 **Currently Working On**
- 🚌 **Angkot to School** — government school-transport platform for Bandung City (NestJS, TypeORM, PostgreSQL + PostGIS, Socket.IO/SSE, OpenStreetMap)
- 🌲 **Rimba** — digital forest inventory system @ PUSTEKHAN ITB (NestJS, MongoDB, RabbitMQ, Go worker, React + Leaflet)
- 🌱 **Automated Plant Phenotyping** — AI analysis pipeline (YOLOv8, FastSAM, ResNet50, PlantNet-300K)

🏆 **Highlights**
- Leading a developer team across **15+ active projects**
- **6 registered software copyrights (HAKI)**
- Research on RL-based smart building systems, targeting international publication

📚 **Currently Deepening**
- Applied **Machine Learning** & **Reinforcement Learning**
- Distributed systems & message-driven architecture (**RabbitMQ**, **Go**)

🤝 **Open to Collaborate On**
- Web platforms & AI/ML research projects with real-world impact
- Open-source tooling for GIS, IoT, and smart systems

🎯 **Goals**
- Publish research & pursue a fully funded **Master's degree** abroad
...
# 📊 GitHub Stats:
![](https://github-readme-streak-stats-eight.vercel.app/?user=faizakailani&theme=aura&hide_border=false)<br/>
...
---
[![](https://visitcount.itsvg.in/api?id=faizakailani&icon=10&color=0)](https://visitcount.itsvg.in)
